...
function viewStudentStats(id, value){
	if(value == 0){
...
function loadStatsPage(){
	...
	document.getElementById("wins").innerHTML = buffWins/5;
	document.getElementById("losses").innerHTML = opponentsWins/5;
}
...
function loadPlayersPage(){
	...
	for(i = 0; i < 4; i++){
		var optCreation = document.createElement('option');
		optCreation.innerHTML = players[i].name;
		optCreation.value = i;
		optCreation.setAttribute("onclick", "switchPlayers"+"("+i+")");
		dropMenu.appendChild(optCreation);
	}
}
